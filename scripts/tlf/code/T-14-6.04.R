...
# Spec:  AN-14-6.04  (analysis-spec.json)
...
# <id>/T-14-6.04.generated.md from that ARD. No value is hand-entered.
if (!exists("SPECS")) {
...
ID <- "T-14-6.04"
spec <- SPECS[["AN-14-6.04"]]
cat("\n>>>", ID, "-", spec$title, "\n")
gen_shift(ID, spec, by_visit = TRUE, cmh = TRUE)
