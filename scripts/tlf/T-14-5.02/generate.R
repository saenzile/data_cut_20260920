# Name: T-14-5.02.R
# Title: Incidence of Treatment-Emergent Serious Adverse Events by System Organ Class and Preferred Term
# Spec:  AN-14-5.02  (analysis-spec.json)
# Population: Safety Population  |  Dataset: ADAE
# Subset: TRTEMFL = 'Y' AND AESER = 'Y'
# ----------------------------------------------------------------------------
# ARD-first: Phase A computes every statistic into <id>/ard.csv, Phase B renders
# <id>/T-14-5.02.generated.md from that ARD. No value is hand-entered.
if (!exists("SPECS")) {
