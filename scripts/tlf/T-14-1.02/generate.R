...
# Spec:  AN-14-1.02  (analysis-spec.json)
...
# <id>/T-14-1.02.generated.md from that ARD. No value is hand-entered.
if (!exists("SPECS")) {
...
ID <- "T-14-1.02"
spec <- SPECS[["AN-14-1.02"]]
cat("\n>>>", ID, "-", spec$title, "\n")
gen_cat_freq(ID, spec, vars = c("EOSSTT", "DCSREAS"),
  labels = list(EOSSTT = "End of study status", DCSREAS = "Reason for discontinuation"),
  dataset = "ADSL", denom_pop = "Intent-to-Treat")
